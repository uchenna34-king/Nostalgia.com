  ...
  return (
    <main className="container-x py-16">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-3 font-serif text-5xl font-normal">Returns</h1>
        <p className="mt-4 text-ink-soft leading-relaxed">
          We want every piece to feel right. If something is not what you hoped
          for, returning it is simple and unhurried.
        </p>

        <h2 className="font-serif text-2xl font-normal mt-12">Return window</h2>
        <p className="mt-4 text-ink-soft leading-relaxed">
        ...
        <h2 className="font-serif text-2xl font-normal mt-12">Refunds</h2>
        <p className="mt-4 text-ink-soft leading-relaxed">
        ...
        <h2 className="font-serif text-2xl font-normal mt-12">Exchanges</h2>
        <p className="mt-4 text-ink-soft leading-relaxed">
